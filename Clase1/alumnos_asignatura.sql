...
CREATE TABLE `asignatura` (
  ...
  CONSTRAINT `asignatura_ibfk_1` FOREIGN KEY (`profesor`) REFERENCES `profesor` (`rfc`)
...
INSERT INTO `asignatura` VALUES ('1','Bases de Datos','23','Básica','Verdesita','2','PALAS8008');
...
-- Dump completed on 2016-08-13 19:07:19
